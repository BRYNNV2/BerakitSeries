        ...
        <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-8 lg:px-12 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-start text-left">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-zinc-500 font-medium">
                <li><a href="/#hubungi-kami" className="hover:text-[#bef264] transition-colors">Contact Us</a></li>
                <li><a href="/#hubungi-kami" className="hover:text-[#bef264] transition-colors">FAQs</a></li>
                <li><a href="/#hubungi-kami" className="hover:text-[#bef264] transition-colors">Shipping & Returns</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-zinc-500 leading-relaxed font-semibold max-w-[280px]">
                Dapatkan cerita perajin, peluncuran koleksi eksklusif, dan penawaran istimewa langsung di kotak masuk Anda.
              </p>
            </div>
          </div>

          {/* Bottom row */}
          <div className="pt-8 border-t border-zinc-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-600 font-semibold font-mono">
            <span>© {new Date().getFullYear()} BUMDES BERAKIT. ALL RIGHTS RESERVED.</span>
